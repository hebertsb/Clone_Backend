...
DEFAULT_FROM_EMAIL = EMAIL_HOST_USER or "noreply@sistema-reservas.com"

# Configuración específica para reprogramaciones
ADMIN_EMAILS = os.getenv("ADMIN_EMAILS", "admin@tuagencia.com").split(",")
