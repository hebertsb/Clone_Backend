...
def load_seed_data(apps, schema_editor):
    ...
    fixtures = [
        base_dir / "fixtures" / "datos_reserva.json",
    ]
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reservas", "0002_alter_acompanante_table_rename_visitante_acompanante_and_more"),  # asegúrate de que esta sea la anterior correcta
    ]
